...
class project3
{
    ...
    public static void main(String[] args)
    {
        ...
        int []  Weight = {9,13,153,50,15,68,27,39,23,52,11,32,24,48,73,42,43,22,7,18,4,30};
        
        // Names array
        
        String [] Names = {"map","compass","water","sandwich","glucose","tin","banana","apple","chesse",
        "beer","suntan-cream","camera","T-shirt","trousers","umbrella","waterproof-trousers","waterproof-overclothes",
        "notecase","sunglasses","towel","socks","book"};
